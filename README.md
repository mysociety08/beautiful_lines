...
1.  **[The Main Terminal (My Personal Page)](LINK_CATRE_SITE_PERSONAL)** 
    *   **Role:** **COMMAND CENTER**.
    *   **Directive:** This is not just a portfolio. This is the validation mechanism. Everything you find elsewhere—in this repo must be entered here. **Completion of the terminal is the only definition of success.**

2.  **[The "Friend's" Blog](LINK_CATRE_SITE_PRIETEN)** 🟠
    *   **Role:** external target.
    *   **Intel:** A friend claimed he could build a secure website. I audited it. Let's just say... he left some doors open. Go see what he's hiding.
